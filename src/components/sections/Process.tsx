      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="relative mt-12 grid grid-cols-1 md:grid-cols-[1fr_24px_1fr] gap-4">
          ...
          <div className="relative">
            <div ref={lineRef} className="absolute left-1/2 top-0 h-full w-[2px] -translate-x-1/2 bg-gradient-to-b from-neon-cyan via-white/20 to-neon-purple opacity-70" />
          </div>
          <div className="hidden md:block" />
          ...
          {steps.map((s, i) => (
            <React.Fragment key={s.title}>
                  ...
                  >
                    ...
                    <CardContent className="relative">
                      <div className="flex items-center gap-3">
                        <div className="h-8 w-8 rounded-full border border-white/10 bg-white/5 flex items-center justify-center font-mono text-xs text-white/70">
              ...
              <div className="relative hidden md:flex items-start justify-center">
                <div className="mt-5 h-4 w-4 rounded-full bg-neon-cyan shadow-[0_0_30px_rgba(0,255,209,0.35)]" />
              </div>
